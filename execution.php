...
if (isset($_POST['add_product'])) {
    ...
    $insert = "INSERT INTO customer_order (book_name, customer_name, image, quantity, order_date, total_amount,payment_method, tracking_number) VALUES ('$bookn', '$customern', '$image', $quantity, '$order_date', $t_amount, '$pay_method', '$tracking_num')";
...
<script>
    ...
    <script>
        alert("Further information will be delivered to your email")
    </script>
</html>
