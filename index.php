...
<div class="banner">
        ...
        <input type="text" name="search_text" id="search_text" placeholder="Enter book here" class="form-control"/>
    ...
    <div class="containerr">
        <div class="slider">
            <div class="slide">
                <img src="pics/agatha13.jpg" alt="Thirteen Problems">
...
<div class="contact-information">
    <div class="content">
        ...
        <form class="all" method="POST" action="contact.php" autocomplete="off">
