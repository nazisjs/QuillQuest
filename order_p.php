...
if (isset($_POST['add_product'])) {
    ...
    $ship_add = mysqli_real_escape_string($connect, $_POST['card_number']);
    ...
    $insert = "INSERT INTO customer_order (book_name, customer_name, quantity, order_date, total_amount,card_number, payment_method, tracking_number) VALUES ('$bookn', '$customern', $quantity, '$order_date', $t_amount, '$ship_add', '$pay_method', '$tracking_num')";
    ...
    <div class="containerr">
        <div class="admin-product-form-container">
            <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                ...
                <input type="text" placeholder="Book name?" name="book_name" class="box" value="<?php echo isset($_GET['book_name']) ? htmlspecialchars($_GET['book_name']) : ''; ?>">
                ...
                <input type="number" placeholder="Price per book?" name="price_per_book" class="box" id="price_per_book" value="<?php echo isset($_GET['total_amount']) ? htmlspecialchars($_GET['total_amount']) : 700; ?>">
                ...
                <input type="text" placeholder="Code of card?" name="card_number" class="box" maxlength="16">
